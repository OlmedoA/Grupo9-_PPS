<body>
    ...
    <form action=""  method="POST" class="row g-3 formStyle mx-auto py-4 px-4 form">
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="nombre" name="nombre" required="required" readonly = "readonly">
                </div>
                <div class="col-12">
                    <!--apellido, type text-->
                    <label for="apellido" class="form-label">Apellido</label>
                    <input type="text" class="form-control" id="apellido" name="apellido" required="required" readonly = "readonly">  
                </div>
                <div class="col-12">
                    <!--celular, type tel-->
                ...
                <div class="col-12">
                    ...
                    <input type="date" class="form-control"  id="fechaalta" name="fechaalta" required="required" readonly = "readonly">
                </div>  
                <div class="col-12">
                    <!--usuario, type text-->
                    <label for="usuario" class="form-label">Usuario</label>
                    <input type="text" class="form-control" id="usuario" name="usuario" required="required" readonly = "readonly">
                </div>
                <div class="col-12">
