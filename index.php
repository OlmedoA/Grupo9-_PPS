    ...
    <div class="barrita container-fluid ">
        ...
        <form action=""  method="POST" class="row g-3 formStyle mx-auto py-4 px-4 form mesayuda">
            ...
            <div class="col-12">
                ...
                <input type="tel" class="form-control"  id="celular" name="celular" size="14" required="required" placeholder="Código de área sin 0 + celular sin prefijo 15" pattern="[0-9]{10}">
            </div>  
            <!-- <div class="col-12">
