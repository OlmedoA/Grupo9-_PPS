    ...
    <div class="row">
        <div class="barra-lateral col-12 col-sm-auto">
            <nav class="menu d-flex d-sm-block justify-content-center flex-wrap">
                ...
                <li><a href="#"><i class="fa-solid fa-user-plus"></i></i><span> Usuarios <i class="fa-solid fa-chevron-down"></i></span></a>
                    <ul>
                ...
                <li><a href="#"><i class="fa-regular fa-file"></i><span> Historial de Presupusto <i class="fa-solid fa-chevron-down"></i></span></a>
                <ul>
